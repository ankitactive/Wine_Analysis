...
setwd("C:/Users/ankit/Desktop/Wine_Analysis")
getwd()
...
#Normalising the data using clustersim library using min-max method
library(clusterSim)
...
#find out correlation of variables with quality
cor(wine1[,1:12],wine1$quality)

#removing highly co-related variables 
...
library(xlsx)
write.csv (readablerules, "C:/Users/ankit/Desktop/Wine_Analysis/abc.csv")
